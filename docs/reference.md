...
* The [v2 API](https://api.inaturalist.org/v2/docs/) is currently in development, and will
...
Pyinaturalist provides functions to use the v0 and v1 APIs, with partial v2 support available and additional endpoints planned.
