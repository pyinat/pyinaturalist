...
Ready to contribute? Here's how to set up `pyinaturalist` for
local development.

1. Fork_ the `pyinaturalist` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/pyinaturalist.git
...
To run a subset of tests::
	 ...
	 $ py.test test/test_pyinaturalist.py
