...
from pyinaturalist.v2.fields import apply_except_fields, fields_to_dict, obs
...
def get_observations(**params) -> JsonResponse:
    ...
    * See `iNaturalist API v2 documentation <https://api.inaturalist.org/v2/docs>`_ for details on
    ...
    if except_fields:
        params['fields'] = apply_except_fields(obs.to_dict(), except_fields)
    elif params.get('fields') not in ['all', None, {}]:
        params['fields'] = fields_to_dict(params.get('fields'))
