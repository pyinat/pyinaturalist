...
j_histogram_month = SAMPLE_DATA['get_observation_histogram_month']['results']
j_histogram_month_of_year = SAMPLE_DATA['get_observation_histogram_month_of_year']['results']
